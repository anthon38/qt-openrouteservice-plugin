...
#ifndef QGEOROUTINGMANAGERENGINEOPENROUTESERVICE_H
#define QGEOROUTINGMANAGERENGINEOPENROUTESERVICE_H
...
class QGeoRoutingManagerEngineOpenrouteservice : public QGeoRoutingManagerEngine
{
    Q_OBJECT

public:
    QGeoRoutingManagerEngineOpenrouteservice(const QVariantMap &parameters,
                                QGeoServiceProvider::Error *error,
                                QString *errorString);
    ~QGeoRoutingManagerEngineOpenrouteservice();
...
#endif // QGEOROUTINGMANAGERENGINEOPENROUTESERVICE_H
